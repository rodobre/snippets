# -*- coding: utf-8 -*-
"""
Created on Tue Jun 26 10:17:42 2018
...
def draw_networkx_multi_edges(G, pos,
                        edgelist=None,
                        width=1.0,
                        edge_color='k',
                        style='solid',
    ...
    if (not G.is_directed() or not arrows):
        edge_collection = LineCollection(edge_pos,                                 #ici
                                         colors=edge_colors,
                                         rotation=100,
                                         linewidths=lw,
                                         antialiaseds=(1,),
    ...
    if G.is_directed() and arrows:
        ...
        for i, (src, dst) in enumerate(edge_pos):
            ...
            arrow = FancyArrowPatch((x1, y1), (x2, y2),
                                    ...
                                    zorder=1, rad=rad)  # arrows go behind nodes
